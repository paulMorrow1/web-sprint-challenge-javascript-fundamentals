...
("The function 'nestedFunction' is able to access the variable 'internal' because Closures allow functions to reach outside of their scope to access variables, or other data, that may be stored in a wider scope.");
